...
check_removed scripts/gates/m7-complete.sh  "compgen -G 'docs/internal/product/perf/run-*.md'" \
  "a scale run" "M12.2"
check_removed scripts/gates/m9-complete.sh  "compgen -G 'docs/internal/product/perf/run-*cache*.md'" \
  "a cache run" "M12.3"
check_removed scripts/gates/m11-complete.sh "compgen -G 'docs/internal/product/perf/*admission*.md'" \
  "an admission run" "M12.4"
check_removed scripts/gates/m1f-complete.sh "compgen -G 'docs/internal/product/decisions/*protocol-3-2*'" \
